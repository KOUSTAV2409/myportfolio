...
export const WORK_EXPERIENCE: WorkExperience[] = [
  ...
  },
  {
    ...
    id: "work3",
    description:
      "Led development team in building enterprise web applications. Managed project delivery and mentored team members in modern development practices.",
    achievements: [
  ...
  },
  {
    ...
    id: "work4",
    description:
      "Creating in-depth technical content about JavaScript, React, and modern web development. Building community of developers through educational content.",
    achievements: [
  ...
  },
  {
    ...
    id: "work5",
    description:
      "Delivering high-performance web applications for startups and small businesses. Specializing in React, Next.js, and modern frontend architecture.",
    achievements: [
